...
#resumindo ela é uma biblioteca cheia de coisas para facilitar sua vida
...
#iremos codar um programa que retorna algumas das configurações do nosso computador para isso:
...
#3. No final de tudo queremos que o programa imprima qual o sist. operacional e o número de
# bits e as cores do seu PC
