...
https = Net::HTTP.new('reqres.in', 443)#Você construiu um objeto Net::HTTP iniciando com os valores de domínio e porta para fazer chamadas https
...
#status code
puts response.code #exibiu o códio da resposta
