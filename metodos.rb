...
# *O que são métodos?
# Método é uma forma de organizar funções específicas em um programa. E ele permite a reutilização do código, ou seja, evita escrever o mesmo código diversas vezes.
